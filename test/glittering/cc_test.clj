...
(def table-a
  [{:id "5fa91050-8a56-4285-8514-2cab0f95f4d3" :members [1 2 3]}
   {:id "eb0e2e5a-750a-40f7-b0de-8d7e90e82ffb" :members [4 5]}
   {:id "95a4df24-e200-42ca-bafc-f99bd4b22b34" :members [13 14]}])

(def table-b
  [{:id "c566be3f-cfca-4b60-a4cf-4b00eaeee722" :members [6 7 8]}
   {:id "3686d0d5-06f8-4977-90ad-dc718fcd3f73" :members [9 10]}
   {:id "707477b7-6c2a-42c7-87ee-c96d38342189" :members [11 12]}])
...
(defn tuplate-table
  [rows]
  (map (fn [row] (spark/tuple (uuid->long (:id row)) row)) rows))
...
(deftest cc
  (is (= 4 (count (connected-component)))))
